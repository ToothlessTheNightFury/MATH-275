...
# ╔═╡ 96532515-a84e-4d78-80cf-1b2b13af7e82
using DifferentialEquations, Plots, PlutoUI; plotly


# ╔═╡ a343a86c-ae39-11ed-1fba-cf5d16a48a52
function unsolvedDifferentialEquation(unknownFunction, modifiersList, t)
	a, b = modifiersList
	u =  unknownFunction
	#t = withRespectToVar
	du = a*u + b
...
# 	b = u
# 	db = c1*b + c2  # c1 is death rate, c2 is immigration rate
# end

# ╔═╡ bbedb56a-526c-4b8e-9efa-d5446edcfef1
unknownFunction0 = 100

# ╔═╡ fac5a509-1d12-44e0-99cb-db16ffaf2aa6
function solvedODEStatic(t)
	return 60/1.08 + (100-60/1.08)*ℯ^(1.08*t)
end

# ╔═╡ 8b3ef769-ddbf-4c83-8fb8-999d2b0e46ea
function solvedODEs(time)
	return 80 - 80/ℯ^(time/100)
end
	

# ╔═╡ da09b132-57e0-48a2-b9ba-4658060a61b0
endtime = @bind endtime Slider(0.0:0.01:20.0, 20.0, true)

# ╔═╡ 013a0fbd-6cc8-427d-bd30-9d380ab1fe0f
populationChangeRate= @bind uMod Slider(0.0:0.01:5.0, 1.08, true)

# ╔═╡ a0442d3c-845b-4973-b703-ba859da69dbb
# ╠═╡ disabled = true
#=╠═╡

  ╠═╡ =#

# ╔═╡ 32dd863a-767e-452f-9860-2d3ea355fc8d
traps =  @bind traps Slider(0:100,5, true)

# ╔═╡ 726c78cf-b423-4f8b-88cf-4f6dce6c77e7
modifiersList = [uMod, nonUMod]

# ╔═╡ 8d9b7ee7-c7fe-4f45-8610-edb5ffa9ac8b
timeSpan = (0, endtime)

# ╔═╡ 9f80c910-f367-4a81-9dcc-04ab4a2c60b3
startingPopulation = @bind startingPopulation Slider(1:1000, 100, true)

# ╔═╡ 133f1615-a31c-4daf-aa2e-810d113019cb
function solvedODEDynamic(time)
	return nonUMod/populationChangeRate + (startingPopulation-nonUMod/populationChangeRate)*ℯ^(populationChangeRate*time)
end

# ╔═╡ dda0e5db-3613-4f80-8cd1-e234ffe55ea4
p = modifiersList

# ╔═╡ 59a8bc5f-4abe-4053-8473-3284847c96b3
setUpODE = ODEProblem(unsolvedDifferentialEquation, startingPopulation, timeSpan, p)

# ╔═╡ 75680b57-0cd2-4c86-876d-d36eeb70ffea
solvedODE = solve(setUpODE)

# ╔═╡ 9cdd6117-2522-45b3-8b94-ec68cabf1e66

# function solvedODEStatic(time)
# 	return 60/1.08 + (100-60/1.08)*e^(1.08*time)
# end

# ╔═╡ ff18ff02-cc90-4b23-b452-adc123becd22
function yolo(time)
	return time*time
end


# ╔═╡ 8fb25379-8034-4e23-a760-714730570cba
plot(
	[solvedODEStatic],
	...
	title = "Population",
	legend = true,
	xaxis = ("time", font(8, :blue)),
	yaxis = "population",
	xrange = (0, endtime),
	yrange = (-2000, 2000)
	)

# ╔═╡ 41d86ebb-ff94-446d-81c5-2671250511df
plot(
	solvedODE,
...
# ╔═╡ c4e202f4-df25-436a-bd0e-6098693897dd
# ╠═╡ disabled = true
#=╠═╡
 nonUMod = @bind nonUMod Slider(0.0:0.5:20.0,8.0, true)
  ╠═╡ =#

# ╔═╡ c0fd4fd8-7e64-44c0-9a95-7c4d5975234b
nonUMod = -traps*12
...
git-tree-sha1 = "096c30c579557dd970546371d04707be1b280451"
...
git-tree-sha1 = "e93060234ee07225fdb9f1c61f90b4595f8c5fa6"
